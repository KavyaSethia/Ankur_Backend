import {
    Box, Flex, Stack, Heading, Text, Container, Input, Button, SimpleGrid, Avatar, AvatarGroup, useBreakpointValue, Icon, HStack, FormControl, FormLabel, Textarea, useToast,
            ...
            >
              ...
              <Box as={"form"} mt={10}>
                <Stack spacing={4}>
                  ...
                  />
                  <Text color={"gray.500"} fontSize={{ base: "sm", sm: "md" }}>
                    Write the preference where you can provide healing
                  </Text>
                  <HStack>
                    <Box>
